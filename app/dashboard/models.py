...
class BusinessLicenses(models.Model):
    ...
    application_created_date = models.DateTimeField(null=True, blank=True)
    application_requirements_complete = models.DateTimeField(null=True, blank=True)
    payment_date = models.DateTimeField(null=True, blank=True)
    conditional_approval = models.CharField(null=True, blank=True)
    license_term_start_date = models.DateTimeField(null=True, blank=True)
    license_term_expiration_date = models.DateTimeField(null=True, blank=True)
    license_approved_for_issuance = models.DateTimeField(null=True, blank=True)
    date_issued = models.DateTimeField(null=True, blank=True)
    license_status = models.CharField(null=True, blank=True)
    license_status_change_date = models.DateTimeField(null=True, blank=True)
